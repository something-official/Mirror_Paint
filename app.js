...
function savePng() { const link = document.createElement('a'); link.download = 'mirror_paint-canvas.png'; link.href = canvas.toDataURL('image/png'); link.click(); status.textContent = 'PNG prepared locally.'; }
